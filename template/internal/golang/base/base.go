...
// Package base defines shared basic pieces of the $$Command$$ command.
package base
...
// A Command is an implementation of a $$Command$$ command.
type Command struct {
	...
	// Short is the short description shown in the '$$Command$$ help' output.
	Short string

	// Long is the long message shown in the '$$Command$$ help <this-command>' output.
	Long string
	...
	// The order here is the order in which they are printed by '$$Command$$ help'.
	// Note that subcommands are in general best avoided.
	Commands []*Command
}

var MAIN__COMMAND = &Command{
	UsageLine: "$$Command$$",
	Long: `
$$Command$$ is a tool for <REPLACE ME>
...
func (c *Command) LongName() string {
	...
	return strings.TrimPrefix(name, "$$Command$$ ")
}
...
func (c *Command) Usage() {
	...
	fmt.Fprintf(os.Stderr, "Run '$$Command$$ help %s' for details.\n", c.LongName())
	SetExitStatus(2)
	Exit()
}
